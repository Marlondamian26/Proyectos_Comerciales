...
const ROUTES = [
  ...
  { path: "/pagos/sample-id", name: "pago-detalle" },
  { path: "/negocio/pagos", name: "negocio-pagos" },
  { path: "/admin/pagos", name: "admin-pagos" },
  { path: "/negocio", name: "negocio" },
  { path: "/negocio/mi-negocio", name: "negocio-mi-negocio" },
  { path: "/negocio/horarios", name: "negocio-horarios" },
  { path: "/negocio/productos", name: "negocio-productos" },
  { path: "/negocio/servicios", name: "negocio-servicios" },
  { path: "/negocio/inventario", name: "negocio-inventario" },
  { path: "/negocio/logistica", name: "negocio-logistica" },
  { path: "/negocio/pedidos", name: "negocio-pedidos" },
  { path: "/negocio/reservas", name: "negocio-reservas" },
  { path: "/negocio/ventas", name: "negocio-ventas" },
  { path: "/cliente", name: "cliente" },
  { path: "/logistica", name: "logistica" },
  { path: "/admin", name: "admin" },
  { path: "/admin/solicitudes", name: "admin-solicitudes" },
  { path: "/negocios/solicitar", name: "solicitar-negocio" },
  { path: "/mis-solicitudes", name: "mis-solicitudes" },
